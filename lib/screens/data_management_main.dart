      ...
      body: SingleChildScrollView(
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              const HeaderTitle(title: "데이터 백업/삭제", subTitle: "Data backup & deletion"),
              Row(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  const Expanded(child: _DecoratedButton(title: "생두 목록 백업", type: 0)),
                  ...
                  IconButton(
                    ...
                    onPressed: () => _dataManagementCtrl.deleteData(context, 0),
                    icon: Icon(
              ...
              Row(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  const Expanded(child: _DecoratedButton(title: "생두 재고 백업", type: 1)),
                  const SizedBox(width: 5),
                  IconButton(
                    style: ElevatedButton.styleFrom(
                      visualDensity: VisualDensity.compact,
                    ...
                    onPressed: () => _dataManagementCtrl.deleteData(context, 1),
                    icon: Icon(
                      Icons.delete_outline_rounded,
                      size: height / 30,
                    ),
              ...
              Row(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  const Expanded(child: _DecoratedButton(title: "원두 재고 백업", type: 2)),
                  const SizedBox(width: 5),
                  IconButton(
                    style: ElevatedButton.styleFrom(
                      visualDensity: VisualDensity.compact,
                    ...
                    onPressed: () => _dataManagementCtrl.deleteData(context, 2),
                    icon: Icon(
                      Icons.delete_outline_rounded,
                      size: height / 30,
                    ),
              ...
              Row(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  const Expanded(child: _DecoratedButton(title: "판매 내역 백업", type: 3)),
                  const SizedBox(width: 5),
                  IconButton(
                    style: ElevatedButton.styleFrom(
                      visualDensity: VisualDensity.compact,
                    ...
                    onPressed: () => _dataManagementCtrl.deleteData(context, 3),
                    icon: Icon(
                      Icons.delete_outline_rounded,
                      size: height / 30,
                    ),
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      onSubmitted: (value) => _dataManagementCtrl.recoverData(context),
                      style: Theme.of(context).textTheme.bodyMedium,
                  ...
                  ElevatedButton(
                    onPressed: () => _dataManagementCtrl.recoverData(context),
                    child: const Text("복구"),
                  ),
                ],
              ),
