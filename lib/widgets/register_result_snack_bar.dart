                      ...
                      Align(
                        ...
                        child: TextButton(
                          ...
                          onPressed: () async {
                            ...
                            if (confirm == true && context.mounted) {
                              final roastingManagementCtrl = Get.find<RoastingManagementController>();
                              roastingManagementCtrl.revokeRecentBlendInsert(context);
                            }
                          },
                          child: const Text("등록 취소"),
                        ),
                          ...
                          Align(
                            ...
                            child: TextButton(
                              ...
                              onPressed: () async {
                                ...
                                if (confirm == true && context.mounted) {
                                  final salesManagementCtrl = Get.find<SalesManagementController>();
                                  salesManagementCtrl.revokeRecentInsert(context);
                                }
                              },
                              child: const Text("등록 취소"),
                            ),
